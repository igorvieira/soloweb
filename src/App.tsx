...
const Layout = ({ children }: { children: React.ReactNode }) => (
  <div className="flex flex-col min-h-screen w-full bg-gradient-to-b from-gray-900 to-purple-900 text-white overflow-x-hidden">
    <Navbar />
  ...
  <>
    <div className="w-full max-w-6xl mx-auto px-4 py-12 md:py-24">
      <div className="flex flex-col-reverse xl:flex-row gap-12 items-center">
        <div className="flex flex-col gap-6 text-left max-w-3xl w-full">
